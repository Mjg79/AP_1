...
public class ChickenButton extends GeneralButton {
    ...
    private static transient Media chickenMedia = new Media(View.class.getResource("farmFrenzySaveFiles/soundTracks/chickenSound.WAV").toExternalForm());
    private static transient MediaPlayer chickenMediaPlayer = new MediaPlayer(chickenMedia);
                ...
                try {
                    if(isPlaying) {
                        if (map.getBudget() >= 100) {
                            ...
                            chickenMediaPlayer.stop();
                            chickenMediaPlayer.play();
                        }
                    }
