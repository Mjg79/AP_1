...
public class Brightness {
    ...
    public static void changeHelicopterBrightness(Node node1, Node node2, Node node3, Node node4, Button hButton)
    {
        ...
        hButton.setOnMouseExited(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
    ...
    public static void changeBrightNess4(Node node1, Node node2, Node node3, Node node4, ImageView imageView) {
    ...
    public static void changeBrightNess5(Node node1, Node node2, Node node3, Node node4, Node node5, ImageView imageView) {
        imageView.setOnMouseEntered(new EventHandler<MouseEvent>() {
            @Override
            public void handle(MouseEvent event) {
                KeyValue infoOpacity = new KeyValue(node1.opacityProperty(), 1);
                ...
                KeyValue volumeOpacity = new KeyValue(node3.opacityProperty(), 1);
                KeyValue levelOpacity = new KeyValue(node4.opacityProperty(), 1);
                KeyValue outputOpacity = new KeyValue(node5.opacityProperty(), 1);
                KeyFrame showInfo = new KeyFrame(Duration.millis(1000), infoOpacity, currentOpacity,
                        volumeOpacity, levelOpacity, outputOpacity);
                Timeline timeline = new Timeline(showInfo);
                timeline.getKeyFrames().add(showInfo);
                timeline.setAutoReverse(true);
                timeline.setCycleCount(1);
        ...
        imageView.setOnMouseExited(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                KeyValue volumeOpacity = new KeyValue(node3.opacityProperty(), 0);
                KeyValue levelOpacity = new KeyValue(node4.opacityProperty(), 0);
                KeyValue outputOpacity = new KeyValue(node5.opacityProperty(), 0);
                KeyFrame showInfo = new KeyFrame(Duration.millis(1000), infoOpacity, currentOpacity,
                        volumeOpacity, levelOpacity, outputOpacity);
                Timeline timeline = new Timeline(showInfo);
                timeline.getKeyFrames().add(showInfo);
